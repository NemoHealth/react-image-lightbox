...
var ReactImageLightbox = /*#__PURE__*/ (function(_Component) {
  ...
  _createClass(ReactImageLightbox, [
    ...
    },
    {
      ...
      value: function handleRotateButtonClick(angle) {
        var nextAngle = (this.state.rotate + angle) % 360; // invert width with height for main source image

        var imageSrc = this.props['mainSrc'];
        var currentWidth = this.imageCache[imageSrc].width;
        var currentHeight = this.imageCache[imageSrc].height;
    ...
    },
    {
      ...
      value: function handleCaptionMousewheel(event) {
        ...
        var _this$caption$getBoun = this.caption.getBoundingClientRect(),
          height = _this$caption$getBoun.height;

        var _this$caption = this.caption,
          scrollHeight = _this$caption.scrollHeight,
          scrollTop = _this$caption.scrollTop;
                  ...
                  /*#__PURE__*/ React__default.createElement(
                    ...
                    /*#__PURE__*/ React__default.createElement('button', {
                      ...
                      onClick: function onClick() {
                        return _this16.handleRotateButtonClick(-90);
                      },
                    })
                  ),
                enableRotate &&
